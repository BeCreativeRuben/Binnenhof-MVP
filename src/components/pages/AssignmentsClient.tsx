                ...
                <div className="grid grid-cols-4 gap-2">
                  {wmDeck.map((tile, idx) => {
                    ...
                    return (
                      ...
                      >
                        {!visible ? (
                          <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#4a78b8]/15 text-xl text-[#355a9a] shadow-inner">
                            ?
                          </span>
                        ) : (
                          <span className="max-h-[5.75rem] w-full overflow-y-auto text-center">{tile.face}</span>
                        )}
                      </button>
                    );
                  })}
              ...
              {wmCompleted && lastTimes.word_memory !== null ? (
                <div className="mt-2 flex flex-wrap gap-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      void saveScore("word_memory", lastTimes.word_memory!, mistakes.word_memory)
                    }
                  >
                    {translate(locale, "Stop & score opslaan")}
                  </Button>
            ...
            <div className="mt-3">
              {wordflashIdle ? (
                <div className="flex flex-col gap-3">
                  ...
                  <ButtonSecondary
                    type="button"
                    onClick={() =>
                      fcMode === "quiz" ? startFlashcardsQuiz() : startFlashcardsReflect()
                    }
                  >
                    {translate(locale, "Start spel")}
                  </ButtonSecondary>
              ...
              {fcDeckIds.length > 0 && !fcFinished && fcCurrentCard ? (
                <div className="space-y-3">
                  ...
                  <div
                    className={[
                      "relative overflow-hidden rounded-3xl border-2 bg-gradient-to-br px-4 py-5 shadow-[0_14px_40px_rgba(109,40,217,0.18)] transition-all duration-500",
                  ...
                  >
                    ...
                    {!fcRevealed ? (
                      ...
                      <div className="mt-4 rounded-2xl border border-white/70 bg-white/90 p-3 text-xs text-zinc-800 shadow-inner">
              ...
              {frIds.length > 0 && !frFinished && frCurrent ? (
                <div className="space-y-3">
                  ...
                  <div className="relative overflow-hidden rounded-3xl border-2 border-cyan-200 bg-gradient-to-br from-cyan-50 via-sky-50 to-indigo-50 px-4 py-5 shadow-[0_14px_40px_rgba(8,145,178,0.2)]">
                    <div
                      className="pointer-events-none absolute -right-6 top-8 h-24 w-24 rounded-full bg-cyan-300/35 blur-2xl"
                      aria-hidden
                    />
                    <p className="text-[11px] font-bold uppercase tracking-wider text-cyan-900">
            ...
            <div className="mt-3">
              ...
              {eoItemIds.length > 0 && !eoFinished ? (
                <div className="space-y-3">
                  ...
                  <div className="relative overflow-hidden rounded-3xl border-2 border-amber-200 bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 px-4 py-5 shadow-[0_14px_36px_rgba(217,119,6,0.2)]">
